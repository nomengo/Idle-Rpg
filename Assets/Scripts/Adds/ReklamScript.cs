...
public class ReklamScript : MonoBehaviour
{
    ...
    private RewardBasedVideoAd rewardedVideoReklam;
    ...
    private void RewardedReklamYukle()
    {
        ...
        rewardedVideoReklam = RewardBasedVideoAd.Instance;
        rewardedVideoReklam.OnAdClosed -= RewardedVideoDelegate;
        rewardedVideoReklam.OnAdClosed += RewardedVideoDelegate;
        rewardedVideoReklam.OnAdFailedToLoad -= RewardedVideoYuklenemedi;
        rewardedVideoReklam.OnAdFailedToLoad += RewardedVideoYuklenemedi;
        rewardedVideoReklam.OnAdRewarded -= RewardedVideoOdullendir;
        rewardedVideoReklam.OnAdRewarded += RewardedVideoOdullendir;

        if (testModu && (string.IsNullOrEmpty(testDeviceID) || string.IsNullOrEmpty(rewardedVideoKimligi)))
        {
#if UNITY_ANDROID
            rewardedVideoReklam.LoadAd(ReklamIstegiOlustur(), "ca-app-pub-3940256099942544/5224354917");
#elif UNITY_IOS
            rewardedVideoReklam.LoadAd( ReklamIstegiOlustur(), "ca-app-pub-3940256099942544/1712485313" );
#endif
        }
        else
            rewardedVideoReklam.LoadAd(ReklamIstegiOlustur(), rewardedVideoKimligi);
